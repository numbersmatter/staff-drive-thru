...
export function NumberDisplay( props: {questionId: string, count: number, increment: () => void, decrement: () => void}) {
  ...
  return (
    <div className="mx-auto w-3/5 flex flex-row  justify-around items-center ">
      ...
      <div id={props.questionId} className="px-3 py-2 bg-slate-400 rounded-md">
